...
class Form(StatesGroup):
    name = State()  # Will be represented in storage as 'Form:'
    action = State()  # Will be represented in storage as 'Form:name'
...
@dp.callback_query_handler(text=["repeate","add"])
async def returnDcitionaryName(call:types.CallbackQuery):
    print(f" Your action is{call.data}")
